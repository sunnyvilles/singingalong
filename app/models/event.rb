class Event < ActiveRecord::Base
  ...
  attr_accessible :title, :other_description, :day,:end_date, :description,:fees, :testimonial_videos_attributes,:workshop_videos_attributes,:testimonials_attributes,:image_0,:image_1,:image_2,:event_type,:caption_0, :caption_1, :caption_2
